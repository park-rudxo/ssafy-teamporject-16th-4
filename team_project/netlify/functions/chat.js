...
export async function handler(event) {
  ...
  try {
    ...
    const messages = [
      {
        role: 'system',
        content: `당신은 LocalHub의 지역 정보/커뮤니티 전문 챗봇입니다. 항상 한국어로 답하세요. 사용자의 질문이 지역/맛집/행사/교통/커뮤니티/관광 관련이면, 먼저 제공된 데이터가 있으면 그 데이터를 우선적으로 참고해서 답하세요. 데이터가 없으면 일반적인 답변을 하되, 지역 정보 앱의 목적에 맞게 짧고 실용적으로 답하세요.`
      },
